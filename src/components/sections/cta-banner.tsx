        ...
        <div className="glow-mesh relative mx-auto max-w-6xl overflow-hidden rounded-3xl border border-border-strong bg-bg-soft px-6 py-16 text-center md:py-20">
          ...
          <div className="relative mx-auto max-w-2xl">
            <h2 className="text-3xl font-bold leading-tight md:text-4xl">
              Stop overpaying for cloud and legacy maintenance
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-muted">
              Book a free 30-minute infrastructure audit. We&apos;ll tell you exactly
              what you can save and how long a migration takes — no fluff, no sales
              pressure.
            </p>
